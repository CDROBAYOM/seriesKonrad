...
class LibrosMovilPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new LibrosMovilState();
}

class LibrosMovilState extends State<LibrosMovilPage> {
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context, index) {            
            return ListTile(
              ...
              subtitle: Text(bookWidget.book.title),              
            );            
          },          
        ),                         
    );
