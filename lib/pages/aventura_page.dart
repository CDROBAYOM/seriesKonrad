...
class AventuraPage extends StatelessWidget {
    ...
    final card = Container(      
      child: Column(
        children: <Widget>[
          Divider(),
          Divider(),
          Title(color: Colors.black, child: Text('AVENTURA')),          
          FadeInImage(
            image: NetworkImage('https://res.cloudinary.com/dlrlog6ij/image/upload/v1588471482/Aventura.jpg'),            
